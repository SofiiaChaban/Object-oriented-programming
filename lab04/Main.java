...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MyList<Composition> compositions = new MyList<>();
        boolean auto = false;
        for(String i: args){
            if(i.equals("-auto")){
                auto = true;
        ...
        try {
            if(auto) {
                scan = new Scanner(new BufferedInputStream(
                        new FileInputStream("C:\\Users\\Sofiia\\IdeaProjects\\chaban-sofiia-lab04\\src\\automode.txt")));
            }
        }
        ...
        while (true) {
            ...
            System.out.println("7 - Перетворити у стрічку і вивести");
            System.out.println("8 - Перетворити у масив і вивести");
            System.out.println("9 - Перевірка на наявність елементу");
            System.out.println("10 -  Використати стандартну серелізацію");
            System.out.println("11 - Використати стандартну десерелізацію");
            ...
            switch (choice) {
                ...
                case 8:
                    ...
                    Object[] newArr = compositions.toArray();
                    for(Object i : newArr){
                        System.out.println(i);
                    }
                    System.out.println("Готово");
                ...
                /*case 9:
                    System.out.println("Введіть назву");
                    scan.nextLine();
                    String nameCont = scan.nextLine();
                    compositions.contains(compositions.get(indexContain-1)));
                    System.out.println("Готово!");
                    break;*/
                case 10:
                    System.out.println("Серелізація запущена");
                    System.out.println("Введіть назву файлу та індекс конмозиції");
                    scan.nextLine();
                    String nameOfFile=scan.nextLine();
                    int indexSer = scan.nextInt();
                    compositions.get(indexSer).serialize(nameOfFile);
                    System.out.println("Готово!");
                    break;
                case  11:
                    System.out.println("Десерелізація запущена");
                    System.out.println("Введіть назву файлу та індекс композиції");
                    scan.nextLine();
                    String nameOfFile2=scan.nextLine();
                    int indexDes = scan.nextInt();
                    compositions.get(indexDes).deserialize(nameOfFile2);
                    System.out.println("Готово!");
                    break;
                case 12:
